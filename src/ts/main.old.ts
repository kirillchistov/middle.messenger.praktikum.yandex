// Управление темой, навигацией и модальными окнами приложения
// Добавил инициализацию форм по селектору страницы
...
if (registerForm) attachFormValidation(registerForm, { logOnSuccess: true });

const loginForm = document.querySelector<HTMLFormElement>('#login-form');
if (loginForm) attachFormValidation(loginForm, { logOnSuccess: true });
